    ...
    <div class="pr-3 py-3 overflow-y-auto">
      <ul class="">
        <li>
          <a
            href="#"
            class="flex items-center py-2 pl-5 text-sm font-normal text-white bg-[#363636]"
          >
            <svg
        ...
        <li>
          <a
            href="#"
            class="flex items-center py-2 pl-5 text-sm font-normal text-white hover:bg-[#363636]"
          >
            <svg
              class="w-6 h-6 fill-white"
              viewBox="0 0 24 24"
          ...
          >
            <button type="button" class="flex rounded-full">
              <img
                ...
                src="https://yt3.ggpht.com/ytc/AMLnZu8zxjKW-fwugdR-fl7Osg_ZA7XS37j9DWx7bsOK=s88-c-k-c0x00ffffff-no-rj"
                alt="user photo"
              />
            </button>

            <span class="ml-5 flex-1">Endel</span>
            <svg
              class="w-4 h-4 fill-[#f80000]"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
            >
              <g class="style-scope yt-icon">
        ...
        <li>
          ...
          >
            <button type="button" class="flex rounded-full">
              <img
                class="w-6 h-6 rounded-full"
                src="https://yt3.ggpht.com/ytc/AMLnZu8AdR1skGj4cVnjVzg5ihmxim0aLNpF2MGO3jHo=s88-c-k-c0x00ffffff-no-rj"
                alt="user photo"
              />
            </button>
            <span class="ml-5 flex-1">Dreamy</span>
        ...
        <li>
          ...
          >
            <button type="button" class="flex rounded-full">
              <img
                class="w-6 h-6 rounded-full"
                src="https://yt3.ggpht.com/ytc/AMLnZu9C_4VJki-D53MM8QLRPWzr48bSSpP3tN5y2GkgLw=s88-c-k-c0x00ffffff-no-rj"
                alt="user photo"
              />
            </button>
            <span class="ml-5 flex-1">Your Food Lab</span>
            <span class="mr-1.5 rounded-full h-1 w-1 bg-sky-500"></span>
          </a>
        </li>
        <li>
          ...
          >
            <button type="button" class="flex rounded-full">
              <img
                class="w-6 h-6 rounded-full"
                src="https://yt3.ggpht.com/ytc/AMLnZu_ELD3tSAb5Bsz2ztU0rY31lzjRe9umVrnUsBGK=s88-c-k-c0x00ffffff-no-rj"
                alt="user photo"
              />
            </button>
            <span class="ml-5">The Exploring Series</span>
          </a>
        </li>
      </ul>
    </div>
